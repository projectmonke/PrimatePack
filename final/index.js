var h=new Set,r=({id:_,cssText:z})=>{if(h.has(_)||document.querySelector(`#${_}`))return;const K=document.createElement("style");K.id=_,K.textContent=z,K.classList.add("evenbetterapi-css-module"),document.head.appendChild(K),h.add(_)},Y=r;var l=`
.eb-checkbox__input {
    cursor: pointer;
...
`,k=()=>{Y({id:"checkbox",cssText:l});const _=document.createElement("div");_.classList.add("eb-button__label");const z=document.createElement("div");z.classList.add("eb-checkbox");const K=document.createElement("div");K.classList.add("formkit-outer"),K.dataset.family="box",K.dataset.type="checkbox",K.dataset.complete="true";const F=document.createElement("label");F.classList.add("formkit-wrapper","eb-checkbox__wrapper"),F.dataset.checked="true";const Z=document.createElement("span");Z.classList.add("formkit-inner","eb-checkbox__inner");const q=document.createElement("input");q.classList.add("formkit-input","eb-checkbox__input"),q.type="checkbox";const G=document.createElement("span");return G.classList.add("formkit-decorator"),G.setAttribute("aria-hidden","true"),Z.appendChild(q),Z.appendChild(G),F.appendChild(Z),K.appendChild(F),z.appendChild(K),_.appendChild(z),_};function I(_){const z=document.createElement("div");z.classList.add("c-menu-bar"),z.style.width="100%";const K=document.createElement("div");K.classList.add("p-menubar","p-component"),K.setAttribute("data-pc-name","menubar"),K.setAttribute("data-pc-section","root");const F=document.createElement("div");F.classList.add("p-menubar-start"),F.setAttribute("data-pc-section","start");const Z=document.createElement("div");Z.classList.add("c-settings__title"),Z.style.padding="0 var(--c-space-4)",Z.style.fontWeight="700",Z.textContent=_.title,F.appendChild(Z);const q=document.createElement("ul");q.classList.add("p-menubar-root-list"),_.items.forEach((Q)=>{const X=document.createElement("li");X.classList.add("p-menuitem"),X.setAttribute("role","menuitem");const H=document.createElement("div");H.classList.add("p-menuitem-content"),H.setAttribute("data-pc-section","content");const A=document.createElement("div");A.classList.add("c-settings__item"),A.setAttribute("data-is-active","true"),A.addEventListener("click",()=>{K.classList.remove("p-menubar-mobile-active")});const $=document.createElement("a");if($.setAttribute("href",Q.url),$.setAttribute("draggable","false"),$.draggable=!1,$.classList.add("p-menuitem-link"),j.eventManager.on("onPageOpen",(f)=>{if(f.newUrl===Q.url){if(Q.onOpen)Q.onOpen();$.style.backgroundColor="rgba(255,255,255,.04)",$.style.borderRadius="var(--c-border-radius-2)"}else $.style.backgroundColor="",$.style.borderRadius=""}),Q.icon){const f=document.createElement("i");f.classList.add("c-icon","fas",Q.icon),f.style.marginRight="var(--c-space-2)",$.appendChild(f)}const w=document.createElement("span");w.textContent=Q.title,$.appendChild(w),A.appendChild($),H.appendChild(A),X.appendChild(H),q.appendChild(X)});const G=document.createElement("a");G.setAttribute("role","button"),G.setAttribute("tabindex","0"),G.classList.add("p-menubar-button"),G.setAttribute("aria-haspopup","true"),G.setAttribute("aria-expanded","false"),G.setAttribute("aria-label","Navigation"),G.setAttribute("data-pc-section","button"),G.setAttribute("aria-controls","pv_id_3"),G.innerHTML='<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="p-icon" aria-hidden="true" data-pc-section="menubuttonicon"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.3226 3.6129H0.677419C0.497757 3.6129 0.325452 3.54152 0.198411 3.41448C0.0713707 3.28744 0 3.11514 0 2.93548C0 2.75581 0.0713707 2.58351 0.198411 2.45647C0.325452 2.32943 0.497757 2.25806 0.677419 2.25806H13.3226C13.5022 2.25806 13.6745 2.32943 13.8016 2.45647C13.9286 2.58351 14 2.75581 14 2.93548C14 3.11514 13.9286 3.28744 13.8016 3.41448C13.6745 3.54152 13.5022 3.6129 13.3226 3.6129ZM13.3226 7.67741H0.677419C0.497757 7.67741 0.325452 7.60604 0.198411 7.479C0.0713707 7.35196 0 7.17965 0 6.99999C0 6.82033 0.0713707 6.64802 0.198411 6.52098C0.325452 6.39394 0.497757 6.32257 0.677419 6.32257H13.3226C13.5022 6.32257 13.6745 6.39394 13.8016 6.52098C13.9286 6.64802 14 6.82033 14 6.99999C14 7.17965 13.9286 7.35196 13.8016 7.479C13.6745 7.60604 13.5022 7.67741 13.3226 7.67741ZM0.677419 11.7419H13.3226C13.5022 11.7419 13.6745 11.6706 13.8016 11.5435C13.9286 11.4165 14 11.2442 14 11.0645C14 10.8848 13.9286 10.7125 13.8016 10.5855C13.6745 10.4585 13.5022 10.3871 13.3226 10.3871H0.677419C0.497757 10.3871 0.325452 10.4585 0.198411 10.5855C0.0713707 10.7125 0 10.8848 0 11.0645C0 11.2442 0.0713707 11.4165 0.198411 11.5435C0.325452 11.6706 0.497757 11.7419 0.677419 11.7419Z" fill="currentColor"></path></svg>',G.addEventListener("click",()=>{K.classList.toggle("p-menubar-mobile-active"),q.style.zIndex=K.classList.contains("p-menubar-mobile-active")?"1200":""}),window.addEventListener("resize",()=>{if(window.innerWidth<955)K.classList.add("p-menubar-mobile");else K.classList.remove("p-menubar-mobile"),K.classList.remove("p-menubar-mobile-active")}),window.dispatchEvent(new Event("resize"));const J=document.createElement("div");if(J.classList.add("p-menubar-end"),J.setAttribute("data-pc-section","end"),J.style.display="flex",J.style.gap=".5em",J.style.alignItems="center",_.customButtons)_.customButtons.forEach((Q)=>{J.appendChild(Q)});return K.appendChild(F),K.appendChild(G),K.appendChild(q),K.appendChild(J),z.appendChild(K),z}var V;(function(F){F["INFO"]="info";F["ERROR"]="error";F["WARN"]="warn"})(V||(V={}));window.global=window;class B{log(_,z){const F=`${(new Date()).toString()} [EvenBetterAPI]`;switch(_){case V.INFO:console.log(`${F} [INFO] ${z}`);break;case V.ERROR:console.error(`${F} [ERROR] ${z}`);break;case V.WARN:console.warn(`${F} [WARN] ${z}`);break;default:console.log(`${F} [UNKNOWN] ${z}`)}}info(_){this.log(V.INFO,_)}error(_){this.log(V.ERROR,_)}warn(_){this.log(V.WARN,_)}}var i=new B,W=i;class R{events={};registerEvent(_,z){this.events[_]=z}triggerEvent(_,z){const K=this.events[_];if(K)K.trigger(z);else console.error(`Event "${_}" not registered.`)}on(_,z){const K=this.events[_];if(K)K.addHandler(z);else console.error(`Event "${_}" not registered.`)}initEvents(){W.info(`Initializing ${Object.keys(this.events).length} custom events`);for(let _ in this.events)this.events[_].init()}}class x{handlers=[];addHandler(_){this.handlers.push(_)}init(){const _=setInterval(()=>{if(m())clearInterval(_),this.trigger()},25)}trigger(){this.handlers.forEach((_)=>_())}}var m=()=>{return document.querySelector(".c-authenticated")!==null};class y{handlers=[];addHandler(_){this.handlers.push(_)}init(){new MutationObserver((z)=>{for(let K of z)if(K.type==="childList")K.addedNodes.forEach((F)=>{const Z=F;if(F.nodeType===1&&Z.classList.contains("p-contextmenu"))this.trigger(Z)})}).observe(document.body,{childList:!0,subtree:!0})}trigger(_){this.handlers.forEach((z)=>z(_))}}class T{handlers=[];eventManager;constructor(_){this.eventManager=_}addHandler(_){this.handlers.push(_)}init(){let _=window.location.href;const z=new MutationObserver(()=>{if(window.location.href!==_){let F=new URL(window.location.href).hash,Z=new URL(_).hash;if(_=window.location.href,F.includes("?custom-path="))F=F.split("?custom-path=")[1];if(Z.includes("?custom-path="))Z=Z.split("?custom-path=")[1];document.querySelector(".c-content")?.setAttribute("data-page",F),this.trigger({newUrl:F,oldUrl:Z})}}),K={subtree:!0,childList:!0};z.observe(document,K)}trigger(_){if(W.info(`Page updated: ${_.oldUrl} -> ${_.newUrl}`),_.newUrl.startsWith("#/settings/"))this.eventManager.triggerEvent("onSettingsTabOpen",_.newUrl.replace("#/settings/",""));this.handlers.forEach((z)=>z(_))}}class P{handlers=[];addHandler(_){this.handlers.push(_)}init(){}trigger(_){W.info(`Settings tab opened: ${_}`),this.handlers.forEach((z)=>z(_))}}var a=`
  .evenbetter-modal {
    position: fixed;
    top: 0;
    left: 0;
...
`;document.addEventListener("keydown",(_)=>{if(_.key==="Escape")E()});var o=({title:_,content:z})=>{Y({id:"evenbetterapi-modal",cssText:a.toString()});const K=document.createElement("div");K.classList.add("evenbetter-modal");const F=document.createElement("div");F.classList.add("evenbetter-modal__content");const Z=document.createElement("div");Z.classList.add("evenbetter-modal__content-header");const q=document.createElement("h2");q.classList.add("evenbetter-modal__content-header-title"),q.textContent=_,Z.appendChild(q);const G=document.createElement("div");G.classList.add("evenbetter-modal__content-body");const J=document.createElement("p");J.classList.add("evenbetter-modal__content-body-text"),J.textContent=z;const Q=document.createElement("button");return Q.classList.add("evenbetter-modal__content-body-close"),Q.textContent="Close",Q.addEventListener("click",E),G.appendChild(J),G.appendChild(Q),F.appendChild(Z),F.appendChild(G),K.appendChild(F),K.setAttribute("data-modal-title",_),K},n=()=>{return document.querySelector(".evenbetter-modal")!==null},E=()=>{document.querySelector(".evenbetter-modal")?.remove()},S=({title:_,content:z})=>{if(n())E();const K=o({title:_,content:z});document.body.appendChild(K)};var t=`
.v-toast--fade-in {
...
}`,e=(_,z,K)=>{const F=document.createElement("div");F.classList.add("v-toast"),F.classList.add(`v-toast--${K}`);const Z=document.createElement("div");Z.setAttribute("role","alert"),Z.classList.add("v-toast__item"),Z.classList.add(`v-toast__item--${z}`),Z.classList.add(`v-toast__item--${K}`),F.appendChild(Z);const q=document.createElement("div");q.classList.add("v-toast__icon"),Z.appendChild(q);const G=document.createElement("p");return G.classList.add("v-toast__text"),G.textContent=_,Z.appendChild(G),F.classList.add("v-toast--fade-in"),F},b=(_)=>{const{message:z,type:K,position:F,duration:Z}=_;Y({id:"eb-toast",cssText:t});let q=document.querySelector(`.v-toast--${F}`);if(!q)q=document.createElement("div"),q.classList.add("v-toast"),q.classList.add(`v-toast--${F}`),document.body.appendChild(q);const G=e(z,K,F);q.appendChild(G),setTimeout(()=>{G.classList.add("v-toast--fade-out"),setTimeout(()=>{G.remove()},150)},Z-150)};function M(_,z="Search...",K=!1,F){Y({id:"eb-text-input",cssText:_1});const Z=document.createElement("div");Z.classList.add("formkit-outer","c-text-input__outer"),Z.setAttribute("style",`width: ${_};`);const q=document.createElement("div");q.classList.add("formkit-wrapper"),q.style.display="flex";const G=document.createElement("div");G.classList.add("formkit-inner","eb-text-input__inner");const J=document.createElement("div");J.classList.add("c-text-input__prefix"),J.setAttribute("style","align-self: center; color: var(--c-fg-subtle);");const Q=document.createElement("i");if(Q.classList.add("c-icon","fas"),F)Q.classList.add(F);const X=document.createElement("input");if(X.setAttribute("placeholder",z),X.setAttribute("spellcheck","false"),X.classList.add("formkit-input","c-text-input__input"),X.setAttribute("type","text"),X.setAttribute("style","width: 100%; background: transparent; border: 0; outline: 0; color: inherit; box-sizing: border-box; line-height: inherit;"),F)J.appendChild(Q);if(G.appendChild(J),G.appendChild(X),K){const H=document.createElement("button");H.innerHTML='<i class="fas fa-copy"></i>',H.setAttribute("style","background: transparent; border: 0; outline: 0; cursor: pointer; padding: 0; margin-left: 10px;"),H.addEventListener("click",()=>{navigator.clipboard.writeText(X.value),j.toast.showToast({message:"Copied to clipboard",position:"bottom",type:"info",duration:1000})}),G.appendChild(H)}return q.appendChild(G),Z.appendChild(q),Z}var _1=`
...
`;class L{handlers=[];commandObserver=null;selectedCommand=null;addHandler(_){this.handlers.push(_)}init(){const _=(F)=>{this.commandObserver=new MutationObserver((Z)=>{const q=z();if(q!==this.selectedCommand)this.selectedCommand=q}),this.commandObserver.observe(F,{attributes:!0,subtree:!0})},z=()=>{return document.querySelector("[command-item][aria-selected='true']")};new MutationObserver((F)=>{for(let Z of F)if(Z.type==="childList")Z.addedNodes.forEach((q)=>{const G=q;if(q.nodeType===1&&G.hasAttribute("command-theme"))_(G)}),Z.removedNodes.forEach((q)=>{const G=q;if(q.nodeType===1&&G.hasAttribute("command-theme")){if(!this.selectedCommand)return;const J=this.selectedCommand.getAttribute("data-value");if(J)this.trigger(J);if(this.commandObserver)this.commandObserver.disconnect(),this.commandObserver=null}})}).observe(document.body,{childList:!0,subtree:!0})}trigger(_){this.handlers.forEach((z)=>z(_))}}var U=window.Caido;var C=[],g=(_)=>{_.on("onCommandRun",(z)=>{const K=C.find((F)=>F.commandName===z);if(!K)return;F1(K)})},F1=(_)=>{const z=document.createElement("div");z.classList.add("custom");const K=document.createElement("div");K.setAttribute("command-root",""),z.appendChild(K);const F=document.createElement("div");F.setAttribute("command-dialog",""),K.appendChild(F);const Z=document.createElement("div");Z.setAttribute("command-dialog-mask",""),Z.style.display="flex",Z.style.justifyContent="center",Z.style.alignItems="center",Z.addEventListener("click",()=>{z.remove()}),F.appendChild(Z);const q=document.createElement("div");q.setAttribute("command-dialog-wrapper",""),q.style.minWidth="600px",q.style.padding="1em",q.style.margin="0",Z.appendChild(q);const G=document.createElement("div");G.setAttribute("command-dialog-body",""),G.style.display="flex",G.style.gap="0.5em",q.addEventListener("click",(X)=>{X.stopPropagation()}),q.appendChild(G);const J=j.components.createTextInput("100%",_.promptPlaceholder);J.style.zIndex="100",J.addEventListener("click",(X)=>{X.stopPropagation()}),G.appendChild(J);const Q=U.ui.button({label:"Submit",variant:"primary"});Q.addEventListener("click",()=>{const X=J.querySelector("input");_.onPrompt(X.value),z.remove()}),G.appendChild(Q),document.body.appendChild(z),J.querySelector("input")?.focus(),J.addEventListener("keydown",(X)=>{if(X.key==="Enter")Q.click();if(X.key==="Escape")z.remove()})},z1=(_,z,K)=>{C.push({commandName:_,promptPlaceholder:z,onPrompt:K})},v={createPromptCommand:z1};var c=async()=>{if(localStorage.getItem("previousPath"))setTimeout(()=>{window.location.hash=localStorage.getItem("previousPath")||"",localStorage.removeItem("previousPath")},200);const _=new WebSocket("ws://localhost:8081");_.addEventListener("open",()=>{j.toast.showToast({message:"Connected to Caido Hot Reloading Server",duration:2000,type:"success",position:"bottom"})}),_.addEventListener("close",()=>{j.toast.showToast({message:"Disconnected from Caido Hot Reloading Server",duration:2000,type:"error",position:"bottom"})}),_.addEventListener("message",(F)=>{try{const Z=JSON.parse(F.data),q=Z.event,G=Z.data;switch(q){case"caido:loadJS":z(G,"");break;case"caido:loadCSS":z("",G);break;case"caido:reload":localStorage.setItem("previousPath",window.location.hash),location.reload();break;default:console.error("Unknown event type received:",q)}}catch(Z){console.error("Error parsing WebSocket message:",Z)}});const z=async(F,Z)=>{const q=await K();if(!q)return;const G={input:{data:q.data,migrations:q.migrations}};if(F)G.input.data.js=F;if(Z)G.input.data.css=Z;return U.graphql.updateViewerSettings(G)},K=async()=>{return await U.graphql.userSettings().then((F)=>{return F.viewer.settings})}};var K1=`
  :root {
    ...
    <div class="toggle-features__content-item">
      ...
      ${K.items.map((F)=>`
        <div class="toggle-features__content-item-toggle">
          ...
          <div>
            <input type="checkbox" name="${F.name}" id="${F.name}" ${J1(F.name)==="true"?"checked":""} />
          </div>
        </div>`).join("")}
    </div>
    <hr />`).join("")}</div>
  ...
  `},s=()=>{Y({id:"evenbetter-settings",cssText:d.toString()});const _=document.createElement("div");return _.innerHTML=Q1(),_.querySelectorAll("input[type=checkbox]").forEach((F)=>{F.addEventListener("change",(Z)=>{const q=Z.target;O(q.name,q.checked?"true":"false")})}),_.querySelector("#petSaveButton").addEventListener("click",()=>{const F=_.querySelector("#gif_url").value,Z=_.querySelector("#gif_width").value,q=_.querySelector("#gif_height").value;O("gif_url",F),O("gif_width",Z),O("gif_height",q)}),_};var p=()=>{U.navigation.addPage("/settings/theprimatepack",{body:s()}),U.menu.registerItem({type:"Settings",label:"The Primate Pack",path:"/settings/theprimatepack",leadingIcon:"fas fa-cat"}),U.commands.register("evenbetter:settings",{name:"Go to The Primate Pack: Settings",group:"The Primate Pack: Navigation",run:()=>{U.navigation.goTo("/settings/theprimatepack")}}),U.commandPalette.register("theprimatepack:settings")};var Y1=()=>{p(),j.eventManager.on("onPageOpen",()=>{localStorage.setItem("previousPath",window.location.hash);const _=document.querySelector(".c-sidebar-item[data-is-active='true']");if(_){let z=_.querySelector(".c-sidebar-item__count");if(z)z.innerHTML=""}})};Y1();
