...
export const primatePackSettingsTab = () => {
  ...
  petSaveButton.addEventListener("click", () => {
    const gifUrl = (container.querySelector("#gif_url") as HTMLInputElement).value;
    const gifWidth = (container.querySelector("#gif_width") as HTMLInputElement).value;
    const gifHeight = (container.querySelector("#gif_height") as HTMLInputElement).value;
